        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-[#E5D3B7]">
          ...
          <div className="px-8 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="w-5 h-5 text-[#9A8478]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-semibold text-[#4A3428] mb-2">
                  Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
