...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:w-64 bg-white border-r border-border z-50">
        {/* Logo */}
        <div className="flex items-center gap-3 px-6 py-6 border-b border-border">
          ...
          <div>
            <h1 className="text-lg font-bold text-text">Elavon</h1>
            <p className="text-xs text-textLight">Admin Panel</p>
          </div>
        </div>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition ${
                location.pathname === item.path
                  ...
                  : 'text-textLight hover:bg-primary/5 hover:text-primary'
              }`}
            >
              {item.icon}
              <span>{item.name}</span>
